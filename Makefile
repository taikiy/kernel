...
copy:
	...
	cp $(USR_BIN_DIR)/shell/build/shell "/Volumes/taiOS BOOT/"
	find programs/bin/*/build -type f ! -name '*.*' -exec cp {} "/Volumes/taiOS BOOT/" \;
	cp $(USR_BIN_DIR)/test/build/test "/Volumes/taiOS BOOT/"
