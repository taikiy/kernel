...
Elf32_Shdr*
get_section_header_table(Elf32_Ehdr* header)
{
...
Elf32_Phdr*
get_program_header_table(Elf32_Ehdr* header)
{
...
get_section_name_string_table(Elf32_Ehdr* header)
{
    ...
    return (char*)((uint32_t)header + get_section_header_table(header)[header->e_shstrndx].sh_offset);
}
